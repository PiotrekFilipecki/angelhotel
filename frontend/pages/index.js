    ...
    <Layout categories={categories}>
      ...
      <section className="intro-section">
          <div class="intro-section_content">
            ...
            <h2 className="section-heading_small">Welcome to Angel Stradom Hotel, located in the beautiful city of Krakow. Our luxurious hotel and apartment facilities offer the ultimate in comfort and style.</h2>
          </div>
      ...
      <div className="bedrooms-image-container">
        ...
        <div class="bedrooms-section_content">
            ...
            <p>Our guest rooms are spacious and beautifully appointed, with high-end finishes and all the modern amenities you need for a relaxing stay. From plush bedding to flat-screen TVs and minibars, we have thought of everything to ensure your comfort.</p>
            <p>Our apartments are the perfect choice for longer stays or for those who want a bit more space and privacy. They come equipped with fully-equipped kitchens and separate living and sleeping areas, so you can feel right at home.</p>
      ...
      <section className="quote-section">
        ...
        But our luxurious accommodations are just the beginning. At Angel Stradom Hotel, we also offer a range of on-site amenities to help you make the most of your stay. Relax in our indoor pool, work up a sweat in our fitness center, or indulge in a treatment at our spa.
        </h3>
      </section>
      ...
      <section className="work-section">
        <h2 className="section-heading">Work & <span>celebrate</span></h2>
        <div className="work-section_content">
          <div className="detail-table">
            <div className="detail-table_row">
              ...
              <span className="detail-table_column right">
                100
              </span>
            </div>
            <div className="detail-table_row">
